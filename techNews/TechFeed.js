...
export default class BusinessFeed extends Component {
  ...
  fetchData(){
      ...
      axios
          .get("https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=fd1c64e155744fb595e54f79c96b3a46")
          .then(response => {
            this.setState({
      ...
      <View style={styles.container}>
        <View style={styles.appTitle}>
          ...
          <View style={styles.appTitleTextContainer}>
            ...
            <Text style={styles.appTitleText}>Tech News</Text>
          </View>          
        </View>
